<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="/templates/admin/images/logo/logo.png" alt=""></a></div>
      <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="/templates/admin/images/logo/dark-logo.png" alt=""></a></div>
      ...
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown"><i data-feather="message-square"></i>
          <ul class="chat-dropdown onhover-show-div">
            <li>
              <div class="media"><img class="img-fluid rounded-circle me-3" src="/templates/admin/images/user/4.jpg" alt="">
            ...
            <li>
              <div class="media"><img class="img-fluid rounded-circle me-3" src="/templates/admin/images/user/1.jpg" alt="">
            ...
            <li>
              <div class="media"><img class="img-fluid rounded-circle me-3" src="/templates/admin/images/user/2.jpg" alt="">
