<div class="card card-solid">
      ...
      <div class="col-xxl-4 col-lg-6">
        <div class="project-box mb-4">
          ...
          <div class="mt-4 float-end">
            <input class="form-check-input" type="checkbox" id="news_active" name="news_active" onclick="activeId(this, {{$item->id}})" {!!$item->active==1? 'checked':''!!}>
            <a class="btn btn-info btn-xs" href="{{route('admin.news.edit', ['id'=>$item->id])}}"><i class="fas fa-pencil-alt me-1"></i>Edit</a>
  ...
  @if ($news_list->lastPage()>1)
    <div class="d-flex justify-content-end mt-4 me-4 mb-4">{{$news_list->links()}}</div>
  @endif
</div>
