<div class="card card-solid">
      ...
      <div class="col-xxl-4 col-lg-6">
        <div class="project-box mb-4">
          ...
          <div class="mt-4 float-end">
            <input class="form-check-input" type="checkbox" id="product_group_active" name="product_group_active" onclick="activeId(this, {{$item->id}})" {!!$item->active==1? 'checked':''!!}>
            <a class="btn btn-info btn-xs" href="{{route('admin.product-group.edit', ['id'=>$item->id])}}"><i class="fas fa-pencil-alt me-1"></i>Edit</a>
  ...
  @if ($product_group_list->lastPage()>1)
    <div class="d-flex justify-content-end mt-4 me-4 mb-4">{{$product_group_list->links()}}</div>
  @endif
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Delete this product group</h5>
...
<script>
    setTimeout(function () { 
      var Toast = Swal.mixin({
        ...
        Toast.fire({ 
          icon: 'error',  
          title:'Error edit about product group!', 
          customClass: {
            title: 'mt-2',
          }
        })
