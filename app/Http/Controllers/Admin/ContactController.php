...
class ContactController extends Controller
{
    ...
    function displayViewInbox(){
        return [
            'page_view' => 'admin.contact.mail',
            'title' => 'Hợp thư mail',
        ];   
    }
    ...
    public function mail(){
        $display_view = self::displayViewInbox();
    ...
    public function active(Request $request){
        ...
        $this->about->updateActiveId($request->id, $data);
        return response()->json(['status'=>'success']);
    }
